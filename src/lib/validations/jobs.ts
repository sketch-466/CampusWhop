...
export const jobPostSchema = z.object({
  ...
  apply_whatsapp: z.string().max(20).optional().or(z.literal('')),
  deadline: z.string().optional(),
  is_paid: z.boolean().default(false),
  pay_range: z.string().max(100).optional().or(z.literal('')),
  ...
  message: 'Please provide at least one contact method — URL, email, or WhatsApp number',
  path: ['apply_method'],
})
