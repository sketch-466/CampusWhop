    ...
    <div className="min-h-screen bg-zinc-950 pb-20">
      <div className="border-b border-zinc-800 bg-zinc-900 px-4 py-5">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-bold text-zinc-100">Admin: Opportunities</h1>
        </div>
        <p className="text-xs text-zinc-500 mt-0.5">
          {pending.length} opportunit{pending.length !== 1 ? 'ies' : 'y'} pending review
        </p>
      </div>
    ...
    <div className="overflow-hidden rounded-xl border border-zinc-800 bg-zinc-900">
      <div className="p-4 space-y-3">
        ...
        <div>
          ...
          <h3 className="mt-2 text-sm font-bold text-zinc-100 leading-tight">
            {opportunity.title}
          </h3>
